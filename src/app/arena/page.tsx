...
export default function ArenaPage() {
  ...
  <a href="/arena/fussball2" className="block border rounded p-4 hover:bg-gray-50 transition">
          <div className="flex items-center gap-3">
            <img src="/media/ball.png" onError={(e)=>{ (e.currentTarget as HTMLImageElement).style.display='none'; }} alt="Fußball" className="w-10 h-10 object-contain" />
            <div>
              <div className="font-semibold">Fußball Lobby</div>
              <div className="text-sm text-gray-600">Erstelle oder tritt Spielen bei</div>
            </div>
          </div>
        </a>
