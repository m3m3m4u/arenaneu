...
export default function LessonPage() {
  ...
  if (!lesson) {
    return (
  <div className="max-w-6xl mx-auto mt-6 sm:mt-10 p-4 sm:p-6 bg-white rounded shadow">
  ...
  return (
  <div className="max-w-6xl mx-auto mt-6 sm:mt-10 p-4 sm:p-6">
  {antiGuess.blocked && (lesson && (lesson.type==='single-choice' || lesson.type==='multiple-choice' || lesson.type==='matching')) && <AntiGuessingOverlay remainingMs={antiGuess.remainingMs} totalMs={antiGuess.cooldownMs} />}
